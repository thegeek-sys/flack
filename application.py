...
#app.config["SECRET_KEY"] = "AD5dG_vpCHECpKMUV6hDAQ"
app.config["SECRET_KEY"] = "7db03323f78b4d7f93624ec69e44d85c"
...
def submit_login(data):
    ...
    if usr not in users:
        ...
        #emit("success", {'success': users}, broadcast=False)
    else:
        #return redirect("/")
...
def submit_message_room(data):
    ...
    print(channels)
    #print(room)
    #emit("success", {'success': 'Test'}, broadcast=False)
